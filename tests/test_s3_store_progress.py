...
class TestS3StoreWithProgress:
    ...
    def test_s3_store_uses_upload_file(self, temp_file, mock_adapter):
        """s3_store() uses upload_file instead of put_object."""
        s3_utils._s3_adapter = mock_adapter
    ...
    def test_s3_store_with_progress_callback(self, temp_file, mock_adapter):
    ...
    def test_s3_store_stores_file_correctly(self, temp_file, mock_adapter):
    ...
    def test_s3_store_with_custom_content_type(self, temp_file, mock_adapter):
    ...
    def test_s3_store_with_cache_control(self, temp_file, mock_adapter):
    ...
    def test_s3_store_with_prefix(self, temp_file, mock_adapter):
        ...
        s3_utils._s3_adapter = prefix_adapter
    ...
    def test_s3_store_with_public_acl(self, temp_file, mock_adapter):
        ...
        s3_utils._s3_adapter = acl_adapter
    ...
    def test_s3_store_with_server_side_encryption(self, temp_file, mock_adapter):
        ...
        s3_utils._s3_adapter = enc_adapter
    ...
    def test_s3_store_calculates_md5_streaming(self, temp_file, mock_adapter):
    ...
    def test_s3_store_fail_if_exists_same_content(self, temp_file, mock_adapter):
